import {LitElement, customElement, html, css, property, CSSResult} from 'lit-element';
...
class TextCustomElement extends LitElement {
    ...
    render() {
        return html`
            <style>
                .text-paragraph {
                    color: ${withProp(this.color, (color:Ihex):string|undefined|CSSResult => {
